...
This repository includes a minimal read-only Model Context Protocol (MCP) server for OpenAI Apps SDK submission and tool scanning.
...
It does not expose private repositories, private quantum job files, personal documents, secrets, credentials, unpublished research, raw backend data, or legal/private evidence files.
